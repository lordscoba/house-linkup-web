...
const SectionWithImage = () => {
  ...
  return (
    <section className="block xl:flex justify-between items-center xl:pl-[71px] xl:pr-[89px] px-[32px] mt-[64px]">
          ...
          return (
            ...
            >
              ...
              <p
                ...
                } xl:text-[28px] text-[16px]  font-semibold xl:border-none border border-[#979797] px-[12px] xl:px-0 rounded-md`}
              >
                {item?.text}
              </p>
            </div>
