...
type Props = {
  ...
  handleRoomLabelClick: () => void;
  handleRoomFileChange: (e: any) => void;
  roomRef: null;
  handleRoomImagePreview: (e: any) => void;
  isRoomImage: boolean;
};

const UploadRoom = ({
  handleRoomFileChange,
  handleRoomImagePreview,
  handleRoomLabelClick,
  isRoomImage,
  roomImageName,
  roomImageUrl,
  roomRef,
  ...
  return (
    <section className="w-full lg:max-w-[228px]">
      <h2 className="text-[18px] font-[600] text-[#000]">Room Image</h2>
